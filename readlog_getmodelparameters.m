...
%                     time_elapsed_CA = 0;
                ...
                fprintf(fid,'%.3f;%.3f;%.3f;%.3f;%.3f;%.3f;%.3f;',head_angles(1),head_angles(2),head_angles(3),eye_angles(1),eye_angles(2),eye_angles(3),euler_distance);
                fprintf(fid,'%.3f;',C18(m));
                fprintf(fid,'%.3f;',C19(m));
                fprintf(fid,'%.3f\n',C20(m));
            end;
        end;
    end;
