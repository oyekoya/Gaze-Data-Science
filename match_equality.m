function [x,y,z] = match_equality(file1,file2,file3)
...
for a=2:size(C13)
    ...
    if (strcmp(C14(a),C16(a))==1)%(&& ...
        ...
        if (timedif>60)%((x1>0)&&(x1<6000))
            head_eye_count = head_eye_count + 1;%x1; 
        end;%
        x1=0; 
    end;
    ...
    if ((strcmp(C14(a),C13(a))==1)|(checkdb(D1,char(C14(a)),char(C13(a)))==1))%( && ...
        ...
        if (timedif>60)%((x2>0)&&(x2<6000))
            model_eye_count = model_eye_count + 1;%x2; 
        end;%
        x2=0; 
    end;
    ...
    if ((strcmp(C14(a),C15(a))==1)|(checkdb(D1,char(C14(a)),char(C15(a)))==1))%( && ...
        ...
        if (timedif>60)%((x3>0)&&(x3<6000))
            random_eye_count = random_eye_count + 1;%x3; 
        end;%
        x3=0; 
    end;
    count = count + timedif;
